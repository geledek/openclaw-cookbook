...
**Source:** https://x.com/ksimback/status/2023362295166873743?s=46  
**Author:** Kevin Simback 🍷 (@KSimback)  
**Saved:** 2026-02-17  
**Type:** X Thread Analysis  

## Summary
Comprehensive guide on reducing OpenClaw API costs by up to 90% through intelligent model routing, prompt caching, and local model integration. Covers why default OpenClaw setups burn money and provides actionable optimization strategies.

## Key Takeaways
1. **Default OpenClaw burns money** by sending all tasks to frontier models ($1000s monthly bills common)
2. **Context accumulation compounds costs** - sessions grow to 200K+ tokens, system prompts re-sent every call
3. **Intelligent routing** - match model capability to task complexity using lightweight vs frontier models
4. **Prompt caching** - 90% cost reduction on repeated system context (SOUL.md, AGENTS.md, etc.)
5. **Local models via Ollama** - zero marginal cost for high-volume, routine tasks
6. **ClawRouter skill** - new OpenClaw-native routing tool (2.4k GitHub stars)
7. **OpenRouter integration** - 300+ models with automatic routing via prompt analysis

## Cost Optimization Framework
**Simple tasks** → Cheap models (DeepSeek, Gemini Flash ~$0.27-0.60/MTok)  
**Medium tasks** → Mid-tier (GPT-4o-mini)  
**Complex tasks** → Strong models (Claude Sonnet)  
**Heavy reasoning** → Frontier models (Opus 4.6, Kimi K2.5)

## Advanced Strategies
- **Heartbeat optimization**: Route to Haiku + use prompt caching = ~$0.50/month vs $100+
- **Session management**: Monitor context accumulation, implement cleanup
- **Cron job optimization**: 96 daily triggers can cost $10-20/day on Opus alone
- **Local deployment**: Qwen 3 32B competitive with Sonnet 3.5, runs 40+ tok/sec on 4090

## Tags
#openclaw #cost-optimization #ai #models #routing #prompt-caching #kevin-simback #api-costs #efficiency
...
![The biggest bang for your buck comes from the latest versions of the open models such as Kimi K2.5 and the recently-released MiniMax M2.5](https://pbs.twimg.com/media/HBOebfrXEAAQLh3.jpg)
...
![](https://pbs.twimg.com/media/HBRk7ayX0AAdFCV.png)
...
![](https://pbs.twimg.com/media/HBOfqSzWkAA3KbO.png)
...
![Even within just Anthropic, you can greatly optimize across models with different pricing tiers](https://pbs.twimg.com/media/HBOdph9bsAACu-7.jpg)
...
![Don't be this guy!](https://pbs.twimg.com/media/HBOZ5OqbMAAVL59.jpg)
...
![OpenAI models offer a variety of options as well](https://pbs.twimg.com/media/HBOd4imXEAA2mvR.jpg)
...
![Gemini models, especially 2.5 Flash, offer great value without sacrificing quality for certain workflows](https://pbs.twimg.com/media/HBOeNZAWQAAfGLf.jpg)
